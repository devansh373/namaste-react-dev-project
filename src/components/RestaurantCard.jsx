...
function RestaurantCard({data}) {
  ...
  return (<>
    <Link to={`/restaurant/${data?.info?.id}`} className="restaurant-card flex-col gap-3 border border-red-500 rounded-2xl overflow-hidden pb-2 w-[300] h-auto cursor-pointer">
